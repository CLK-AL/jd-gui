...
import al.clk.gui.service.actions.ContextualActionsFactoryService;
import al.clk.gui.service.container.ContainerFactoryService;
import al.clk.gui.service.fileloader.FileLoaderService;
import al.clk.gui.service.indexer.IndexerService;
import al.clk.gui.service.mainpanel.PanelFactoryService;
import al.clk.gui.service.pastehandler.PasteHandlerService;
import al.clk.gui.service.platform.PlatformService;
import al.clk.gui.service.preferencespanel.PreferencesPanelService;
import al.clk.gui.service.sourceloader.SourceLoaderService;
import al.clk.gui.service.sourcesaver.SourceSaverService;
import al.clk.gui.service.treenode.TreeNodeFactoryService;
import al.clk.gui.service.type.TypeFactoryService;
import al.clk.gui.service.uriloader.UriLoaderService;
import al.clk.gui.spi.*;
import al.clk.gui.util.exception.ExceptionUtil;
import al.clk.gui.util.net.UriUtil;
import al.clk.gui.util.swing.SwingUtil;
import al.clk.gui.view.MainView;
...
public class MainController
	...
	protected void onJdGuiIssues() {
		if (Desktop.isDesktopSupported()) {
			...
			if (desktop.isSupported(Desktop.Action.BROWSE)) {
				try {
					desktop.browse(URI.create("https://github.com/java-decompiler/gui/issues"));
				} catch (IOException e) {
					assert ExceptionUtil.printStackTrace(e);
				}
			}
