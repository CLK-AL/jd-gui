...
import al.clk.gui.Constants;
import al.clk.gui.api.API;
import al.clk.gui.api.feature.*;
import al.clk.gui.model.configuration.Configuration;
import al.clk.gui.model.history.History;
import al.clk.gui.service.platform.PlatformService;
import al.clk.gui.util.exception.ExceptionUtil;
import al.clk.gui.view.component.IconButton;
import al.clk.gui.view.component.panel.MainTabbedPanel;
...
import static al.clk.gui.util.swing.SwingUtil.*;
...
public class MainView<T extends JComponent & UriGettable>
	...
	public MainView(Configuration configuration,
		...
		invokeLater(() -> {
			...
			mainFrame.setIconImages(Arrays.asList(getImage("/al/clk/gui/images/jd_icon_32.png"),
			                                      getImage("/al/clk/gui/images/jd_icon_64.png"),
			                                      getImage("/al/clk/gui/images/jd_icon_128.png")));
			...
			Action findNextAction = newAction("Next",
			                                  newImageIcon("/al/clk/gui/images/next_nav.png"),
			                                  true,
			...
			IconButton findNextButton = new IconButton("Next",
			                                           newAction(newImageIcon("/al/clk/gui/images/next_nav.png"),
			                                                     true,
			                                                     findNextActionListener));
			...
			IconButton findPreviousButton = new IconButton("Previous",
			                                               newAction(newImageIcon("/al/clk/gui/images/prev_nav.png"),
			                                                         true,
			...
			findCloseButton.setIcon(newImageIcon("/al/clk/gui/images/close.gif"));
			findCloseButton.setRolloverIcon(newImageIcon("/al/clk/gui/images/close_active.gif"));
			...
			Action openAction = newAction("Open File...",
			                              newImageIcon("/al/clk/gui/images/open.png"),
			                              true,
			                              "Open a file",
			                              openActionListener);
			...
			Action saveAction = newAction("Save",
			                              newImageIcon("/al/clk/gui/images/save.png"),
			                              false,
			                              saveActionListener);
			Action saveAllSourcesAction = newAction("Save All Sources",
			                                        newImageIcon("/al/clk/gui/images/save_all.png"),
			                                        false,
			...
			Action copyAction = newAction("Copy",
			                              newImageIcon("/al/clk/gui/images/copy.png"),
			                              false,
			                              copyActionListener);
			Action pasteAction = newAction("Paste Log",
			                               newImageIcon("/al/clk/gui/images/paste.png"),
			                               true,
			                               pasteActionListener);
			...
			openTypeAction = newAction("Open Type...",
			                           newImageIcon("/al/clk/gui/images/open_type.png"),
			                           false,
			...
			backwardAction = newAction("Back",
			                           newImageIcon("/al/clk/gui/images/backward_nav.png"),
			                           false,
			                           backwardActionListener);
			forwardAction = newAction("Forward",
			                          newImageIcon("/al/clk/gui/images/forward_nav.png"),
			                          false,
			                          forwardActionListener);
			Action searchAction = newAction("Search...",
			                                newImageIcon("/al/clk/gui/images/search_src.png"),
			                                false,
			...
			Action jdGuiIssuesActionAction = newAction("gui issues",
			                                           browser,
			                                           "Open gui issues page",
			...
			Action preferencesAction = newAction("Preferences...",
			                                     newImageIcon("/al/clk/gui/images/preferences.png"),
			                                     true,
