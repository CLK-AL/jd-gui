...
public class MethodProcessorRunnable
	...
	public static RootStatement codeToJava(StructClass cl,
		...
		try {
			...
			// Prevent ThreadLocal memory leaks by cleaning up after method completion
			debugCurrentlyDecompiling.remove();
			debugCurrentCFG.remove();
			debugCurrentDecompileRecord.remove();
			Exprent.cleanupInferredLambdaTypes();
		}
	}
	...
	public void run() {
		...
		try {
			...
			// Use remove() instead of set(null) to prevent ThreadLocal memory leaks
			DecompilerContext.removeCurrentContext();
		}
	...
	/**
	 * Waits for the method processing to complete, with a timeout.
	 *
	 * @param timeout the maximum time to wait in milliseconds
	 * @return true if processing completed, false if timeout elapsed
	 * @throws InterruptedException if the current thread is interrupted while waiting
	 */
	public boolean awaitCompletion(long timeout)
					throws
					InterruptedException {
		return completionLatch.await(timeout,
