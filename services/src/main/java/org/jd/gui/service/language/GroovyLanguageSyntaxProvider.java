...
public class GroovyLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getDisplayName() { return "Groovy"; }
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_GROOVY; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("groovy", "gradle", "gvy", "gy", "gsh"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.GroovyTokenMaker"; }
