...
public class CssLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getDisplayName() { return "CSS"; }
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_CSS; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("css"); }
