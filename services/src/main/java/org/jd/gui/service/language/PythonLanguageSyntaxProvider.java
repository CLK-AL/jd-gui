...
public class PythonLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getDisplayName() { return "Python"; }
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_PYTHON; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("py", "pyw", "pyi", "pyx"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.PythonTokenMaker"; }
