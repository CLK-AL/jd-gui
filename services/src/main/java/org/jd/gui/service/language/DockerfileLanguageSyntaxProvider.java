...
public class DockerfileLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getDisplayName() { return "Dockerfile"; }
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_DOCKERFILE; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("dockerfile"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.DockerTokenMaker"; }
