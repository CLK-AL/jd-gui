...
public class CSharpLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_CSHARP; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("cs", "csx"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.CSharpTokenMaker"; }
