...
public class MarkdownLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getDisplayName() { return "Markdown"; }
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_MARKDOWN; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("md", "markdown", "mdown", "mkdn"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.MarkdownTokenMaker"; }
