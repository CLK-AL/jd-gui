...
public class GoLanguageSyntaxProvider extends AbstractLanguageSyntaxProvider {
    ...
    @Override public String getSyntaxStyle() { return SyntaxConstants.SYNTAX_STYLE_GO; }
    @Override public Collection<String> getFileExtensions() { return Arrays.asList("go"); }
    @Override public String getTokenMakerClassName() { return "org.fife.ui.rsyntaxtextarea.modes.GoTokenMaker"; }
